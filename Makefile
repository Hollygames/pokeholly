...
am__theforgottenserver_SOURCES_DIST = account.h actions.cpp actions.h \
	...
	databasemysql.cpp databasemysql.h databasepgsql.cpp \
	databasepgsql.h databaseodbc.cpp databaseodbc.h depot.cpp \
	depot.h exception.cpp exception.h fileloader.cpp fileloader.h \
	game.cpp game.h gameservers.cpp gameservers.h globalevent.cpp \
...
#am__objects_3 = databasepgsql.$(OBJEXT)
#am__objects_4 = databaseodbc.$(OBJEXT)
...
am_theforgottenserver_OBJECTS = actions.$(OBJEXT) $(am__objects_1) \
	...
	$(am__objects_4) depot.$(OBJEXT) exception.$(OBJEXT) \
	fileloader.$(OBJEXT) game.$(OBJEXT) $(am__objects_5) \
	globalevent.$(OBJEXT) group.$(OBJEXT) gui.$(OBJEXT) \
	house.$(OBJEXT) housetile.$(OBJEXT) inputbox.$(OBJEXT) \
	ioban.$(OBJEXT) ioguild.$(OBJEXT) iologindata.$(OBJEXT) \
	iomap.$(OBJEXT) iomapserialize.$(OBJEXT) item.$(OBJEXT) \
...
am__depfiles_remade = ./$(DEPDIR)/actions.Po ./$(DEPDIR)/admin.Po \
	...
	./$(DEPDIR)/depot.Po ./$(DEPDIR)/exception.Po \
	./$(DEPDIR)/fileloader.Po ./$(DEPDIR)/game.Po \
	./$(DEPDIR)/gameservers.Po ./$(DEPDIR)/globalevent.Po \
	./$(DEPDIR)/group.Po ./$(DEPDIR)/gui.Po ./$(DEPDIR)/house.Po \
...
ACLOCAL = ${SHELL} '/home/servidor/src/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/servidor/src/missing' autoconf
AUTOHEADER = ${SHELL} '/home/servidor/src/missing' autoheader
AUTOMAKE = ${SHELL} '/home/servidor/src/missing' automake-1.16
AWK = gawk
CPPFLAGS = 
CXX = g++
CXXCPP = g++ -E
...
LUA_LIBS = -llua5.1
MAKEINFO = ${SHELL} '/home/servidor/src/missing' makeinfo
...
ODBC_FLAGS = 
ODBC_LIBS = 
OPTIONAL_FLAGS =  -D__ENABLE_SERVER_DIAGNOSTIC__ -D__ROOT_PERMISSION__
PACKAGE = theforgottenserver
PACKAGE_BUGREPORT = 
PACKAGE_NAME = TheForgottenServer
PACKAGE_STRING = TheForgottenServer 0.3.6
...
XML_LIBS = -lxml2
abs_builddir = /home/servidor/src
abs_srcdir = /home/servidor/src
abs_top_builddir = /home/servidor/src
abs_top_srcdir = /home/servidor/src
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/servidor/src/install-sh
